...
{		
	...
	public static $salutation_array=array(
										"Mr."	=>	"Mr.",
										"Mrs."	=>	"Mrs.",
										"Miss."	=>	"Miss."									
										);		
	...
	public static $dateFormat_jQuery=array(
							'd/m/Y'=>'dd/mm/yyyy',
							'd-m-Y'=>'dd-mm-yyyy',
							'd/m/y'=>'dd/mm/yy',
							'd-m-y'=>'dd-mm-yy',
	...
	public static $dateFormat_MySQL=array(
							'd/m/Y'=>'%d/%m/%Y',
							'd-m-Y'=>'%d-%m-%Y',
							'd/m/y'=>'%d/%m/%y',
							'd-m-y'=>'%d-%m-%y',
	...
	public static $timeZoneValues=array(
						'Pacific/Apia' => '-11:00',
						'Pacific/Niue' => '-11:00',
...
public static $pagination=array(
	...
	public static $MonthIndex=array(
						"January"=>"1",
						"February"=>"2",
						"March"=>"3",
						"April"=>"4",
	...
	public static $MotorInsuredItems = array(
			"M" => "MARKET",
			"R" => "RETAIL",
		);
	
	public static $AddressType		=	array(
			"Residential"	=> 0,
			"Postal" 		=> 1,
			"Night"	 		=> 2,
			"Day" 			=> 3
	...
	public static $YesNoIndicator	=	array(
			array("Value"=>"Y","Description"=>"YES"),
			array("Value"=>"N","Description"=>"NO")
		);
	
	/*  For mh-buzz category */
	
	public static $BuzzCategory	=	array(
			1	=>	"Biz Community",
			2	=>	"Cover",
			3	=>	"Maintenance Plans",
			4	=>	"Press Room"

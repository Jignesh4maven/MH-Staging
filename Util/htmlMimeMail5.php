    ...
    */
    public function __construct()
    {
        ...
        */
        ...
        $this->smtp_params['host'] = 'email-smtp.us-east-1.amazonaws.com';
        $this->smtp_params['port'] = 25;
        $this->smtp_params['helo'] = $helo;
        $this->smtp_params['auth'] = false;
        $this->smtp_params['user'] = 'AKIAJXRJ2JYJRRAK44WQ';
        $this->smtp_params['pass'] = 'At3RNvM85pYGiRpIirpSsXuwo253/b6PO8lOvF7m6C52';

<div id="modulename" data-modulename="customers"></div>
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form role="form" name="frm_search" id="frm_search"   {literal} data-before="validate_form({'frm':'frm_search'})" {/literal} >
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-hover table-striped">
                    ...
                    {foreach from=$load_result key=k item=v}
                        <tr id="row_{$v.id}">
                            ...
                            <td>{$v.date}</td>
                            <td>
                                <button class="btn btn-primary btn-sm btn-flat" data-module="customers" data-action="edit"  onclick="_edit('{$v.id}',this)">Edit</button>
                                <button class="btn btn-danger btn-sm btn-flat"  data-module="customers" data-action="delete" onclick="delete_row_by_id('{$v.id}',this)">Delete</button>
                            </td>
                        </tr>
                    {/foreach}
                    </tbody>
                ...
                <script data-tmpl="data-list" type="text/html">
                    <tr id="row_<@=id@>">
                        ...
                        <td><@=date@></td>
                        <td>
                            <button class="btn btn-primary btn-sm btn-flat" data-module="customers" data-action="edit" onclick="_edit('<@=id@>',this)">Edit</button>
                            <button class="btn btn-danger btn-sm btn-flat"  data-module="customers" data-action="delete" onclick="delete_row_by_id('<@=id@>',this)">Delete</button>
                        </td>
                    </tr>
                </script>
            </div><!-- /.box-body -->
...
<script>
    ...
    function _add(){
        modal_params = {"id":"add_edit_","modal_dialog_size" : "modal-lg",
            "iframe":"customers&opcode=form_add_edit&popup",
            "title":"Add New Customer","width":"100%","height":"420px",
        };
    ...
    function _edit(id,el){
        ...
        modal_params = {"id":"add_edit_"+id,"modal_dialog_size" : "modal-lg",
            "iframe":"customers&opcode=form_add_edit&popup&customer_id="+id,
            "title":"Update Customer","width":"100%","height":"420px",
        };
        open_modal(modal_params);
    }

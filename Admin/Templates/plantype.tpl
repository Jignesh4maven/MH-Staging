   <div id="modulename" data-modulename="plantype"></div>
               ...
               <div class="well">
                 <div class="well-body">
				  ...
				  <div class="col-lg-12 col-md-12">
					 ...
					 <form role="form"  id="frm_search" name="frm_search" class="form-inline" action="{$ADMIN_ALIAS}/plantype" data-before="validate_search()">
                ...
                <div class="flip-scroll">
                  <table class="table table-bordered table-striped table-condensed flip-content">
                    <thead class="flip-content bordered-palegreen">
                     ...
                     <tr>
                        <th class="col-center" width="10%">Logo</th>
						<th>Plan name </th>
					...
					{foreach from=$load_result key=k item=v}
                      <tr id="row_{$v.id}">
						<td class="col-center">
							{if $v.img_url !="" && $v.img_name !=""}
							<img src="{$v.img_url}{$v.img_name}" alt="plantype_image" style="height: 40px; width: 40px;"/>
							{else}
							<img src="{$TEMPLATE_IMAGES}noimage.png" alt="plantype_image" style="height: 60px; width: 60px;"/>
							{/if}
						</td>
                        <td>{$v.title}</td>
						<td class="col-center">
						...
						<td class="col-center">
						   <button class="btn btn-primary btn-sm btn-flat" data-module="plantype" data-action="edit"  onclick="_edit('{$v.id}',this)">Edit</button>
						
						  <button class="btn btn-danger btn-sm btn-flat"  data-module="plantype" data-action="delete" onclick="delete_row_by_id('{$v.id}',this)">Delete</button>
						</td>
                     </tr>
					{/foreach}
                    </tbody>
				  ...
				  <tr id="row_<@=id@>">
					<td class="col-center">
						<img src="<@=img_url@><@=img_name@>" alt="plantype_image" style="height: 40px; width: 40px;"/>
					</td>
					<td><@=title@></td>
					<td class="col-center">
					 ...
					 <td class="col-center">
						<button class="btn btn-primary btn-sm btn-flat" data-module="plantype" data-action="edit" onclick="_edit('<@=id@>',this)">Edit</button>
					 
						<button class="btn btn-danger btn-sm btn-flat"  data-module="plantype" data-action="delete" onclick="delete_row_by_id('<@=id@>',this)">Delete</button>
					 </td>
				  </tr>
				  </script
				  <div class="clearfix"></div>
...
function _add(){
	modal_params = {"id":"add_edit_","modal_dialog_size" : "modal-lg",
					"iframe":admin_path+"plantype?opcode=form_add_edit&popup",
					"title":"Plantype","width":"100%","height":"600px",
				};	
...
function _edit(id,el){
	...
	modal_params = {"id":"add_edit_"+id,"modal_dialog_size" : "modal-lg",
					"iframe":admin_path+"plantype?opcode=form_add_edit&popup&plantype_id="+id,
					"title":"Update Plan","width":"100%","height":"600px",
				};	
	open_modal(modal_params);
}

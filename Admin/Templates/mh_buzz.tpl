<div id="modulename" data-modulename="mhbuzz"></div>
			...
			<div class="well">
			  <div class="well-body">
			   ...
			   <div class="col-lg-12 col-md-12">
				  ...
				  <form role="form"  id="frm_search" name="frm_search" class="form-inline" action="{$ADMIN_ALIAS}/mhbuzz" data-before="validate_search()">
					 ...
					 <div class="col-lg-12 col-md-12">
						<div class="form-group">
						   ...
						   <input type="text" placeholder="Enter Title" id="mh_buzz_search_title" name="mh_buzz_search_title" class="form-control ajx-control">
						   
						   <select name="mh_buzz_search_status" id="mh_buzz_search_status" class="form-control ajx-control" >
							  <option value="" disabled="disabled" selected="selected">Select Status</option>
							  <option value="Active">Active</option>
							  <option value="Inactive">Inactive</option> 
						   </select>
						   
						   <select id="mh_buzz_categroy" name="mh_buzz_categroy"  class="form-control ajx-control">
			 ...
			 <div class="flip-scroll">
				  ...
				  {foreach from=$load_result key=k item=v}
				   <tr id="row_{$v.id}">
					...
					<td>
					 ...
					 <td class="col-center">
					   <button class="btn btn-primary btn-sm btn-flat" data-module="mhbuzz" data-action="edit"  onclick="_edit('{$v.id}',this)">Edit</button>
					 
					   <button class="btn btn-danger btn-sm btn-flat"  data-module="mhbuzz" data-action="delete" onclick="delete_row_by_id('{$v.id}',this)">Delete</button>
					 </td>
					</tr>
				   {/foreach}
				 </tbody>
			   ...
			   <tr id="row_<@=id@>">
				  ...
				  <td class="col-center">
					 <button class="btn btn-primary btn-sm btn-flat" data-module="mhbuzz" data-action="edit" onclick="_edit('<@=id@>',this)">Edit</button>
				  
					 <button class="btn btn-danger btn-sm btn-flat"  data-module="mhbuzz" data-action="delete" onclick="delete_row_by_id('<@=id@>',this)">Delete</button>
				  </td>
			   </tr>
			   </script>
				 <div class="clearfix"></div>
...
$(el).addClass("spin-loader");		   
$("#mh_buzz_search_title").val("");
$("#mh_buzz_search_status").val("");
$("#mh_buzz_categroy").val("");
trigger_form({	"frm":"frm_search",
				 "ajxcallback":function(resdata){
					 search_response(resdata);
					 $(el).removeClass("spin-loader");
...
function _add(){
 modal_params = {"id":"add_edit_","modal_dialog_size" : "modal-lg",
				 "iframe":admin_path+"mhbuzz?opcode=form_add_edit&popup",
				 "title":"MH-Buzz","width":"100%","height":"627px",
			 };	
...
function _edit(id,el){
 ...
 modal_params = {"id":"add_edit_"+id,"modal_dialog_size" : "modal-lg",
				 "iframe":admin_path+"mhbuzz?opcode=form_add_edit&popup&buzz_id="+id,
				 "title":"Update MH-Buzz","width":"100%","height":"627px",
			 };	
 open_modal(modal_params);
}
...
module_properties["mhbuzz"] = {
 "template_id":"data-list","template_place_id":"data-list",
 "total_record":total_record,"entries_per_page":entries_per_page,
 "func_data_list_records":"get_data_records","search_controlls":['mh_buzz_search_title','mh_buzz_search_status','mh_buzz_categroy'],

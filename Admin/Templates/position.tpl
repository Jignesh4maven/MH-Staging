<div id="modulename" data-modulename="positions"></div>
			...
			<div class="well">
			  <div class="well-body">
			   ...
			   <div class="col-lg-12 col-md-12">
				  ...
				  <form role="form"  id="frm_search" name="frm_search" class="form-inline" action="{$ADMIN_ALIAS}/position" data-before="validate_search()">
					 ...
					 <div class="col-lg-12 col-md-12">
						<div class="form-group">
						   ...
						   <input type="text" placeholder="Enter position title" id="srch_position_title" name="srch_position_title" class="form-control ajx-control">
						   
						   <select name="srch_position_status" id="srch_position_status" class="form-control ajx-control" >
			 ...
			 <div class="flip-scroll">
			   <table class="table table-bordered table-striped table-condensed flip-content">
				...
				<tr>
				 ...
				 <tbody id="data-list">
					<!--{foreach from=$load_result key=k item=v}_-->
					<tr id="row_{$v.id}">
						<td>{$v.title}</td>
						<td class="col-center" >
						{if $v.status=='Active'}
...
$(el).addClass("spin-loader");		   
$("#srch_position_title").val("");
$("#srch_position_status").val("");
...
function _add(){
 modal_params = {"id":"add_edit_","modal_dialog_size" : "modal-lg",
				 "iframe":admin_path+"position?opcode=form_add_edit&popup",
				 "title":"POsition","width":"100%","height":"627px",
			 };	
...
module_properties["position"] = {
 "template_id":"data-list","template_place_id":"data-list",
 "total_record":total_record,"entries_per_page":entries_per_page,
 "func_data_list_records":"get_data_records","search_controlls":['srch_position_title','srch_position_status'],

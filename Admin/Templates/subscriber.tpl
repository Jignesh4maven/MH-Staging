<div id="modulename" data-modulename="subscriber"></div>
			...
			<div class="well">
			  <div class="well-body">
			   ...
			   <div class="col-lg-12 col-md-12">
				  ...
				  <form role="form"  id="frm_search" name="frm_search" class="form-inline" action="{$ADMIN_ALIAS}/subscriber" data-before="validate_search()">
					 ...
					 <div class="col-lg-12 col-md-12">
						<div class="form-group">
						   ...
						   <input type="text" placeholder="Enter Subsciber name" id="srch_subscriber_name" name="srch_subscriber_name" class="form-control ajx-control">
						   
						   <select name="srch_subscriber_status" id="srch_subscriber_status" class="form-control ajx-control" >
			 ...
			 <div class="flip-scroll">
				...
				<tr>
				 ...
				 <tbody id="data-list">
					...
					<tr id="row_{$v.id}">
						...
						<td class="col-center">
						<button class="btn btn-primary btn-sm btn-flat" data-module="subscriber" data-action="edit"  onclick="_edit('{$v.id}',this)">Edit</button>
					 
						<button class="btn btn-danger btn-sm btn-flat"  data-module="subscriber" data-action="delete" onclick="delete_row_by_id('{$v.id}',this)">Delete</button>
						</td>
					</tr>
					{/foreach}
				 </tbody>
			   ...
			   <tr id="row_<@=id@>">
					...
					<td class="col-center">
					   <button class="btn btn-primary btn-sm btn-flat" data-module="subscriber" data-action="edit" onclick="_edit('<@=id@>',this)">Edit</button>
					
					   <button class="btn btn-danger btn-sm btn-flat"  data-module="subscriber" data-action="delete" onclick="delete_row_by_id('<@=id@>',this)">Delete</button>
					</td>
			   </tr>
			   </script>
				 <div class="clearfix"></div>
...
$(el).addClass("spin-loader");		   
$("#srch_subscriber_name").val("");
$("#srch_subscriber_status").val("");
...
function _edit(id,el){
 ...
 modal_params = {"id":"add_edit_"+id,"modal_dialog_size" : "modal-lg",
				 "iframe":admin_path+"subscriber?opcode=form_add_edit&popup&subscriber_id="+id,
				 "title":"Update Subsciber Detail","width":"100%","height":"300px",
			 };	
...
module_properties["subscriber"] = {
 "template_id":"data-list","template_place_id":"data-list",
 "total_record":total_record,"entries_per_page":entries_per_page,
 "func_data_list_records":"get_data_records","search_controlls":['srch_subscriber_name','srch_subscriber_status'],

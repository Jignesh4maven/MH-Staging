				  ...
				  <div class="col-lg-8 col-md-8">
					 ...
					 <form role="form" class="form-inline">
						...
						<div class="row customer-feedback">
						   <div class="col-lg-5 col-md-5">
							  <div class="form-group">
								 <label for="job_at_name" class="customer-label">Name</label>
								 <input type="text" id="job_at_name" name="job_at_name" class="form-control ajx-control">
							  </div>
						   </div>
						   <div class="col-lg-7 col-md-7">
							  <div class="form-group">
								 <label for="phone_no" class="customer-label">Phone No</label>
								 <input type="text" placeholder="Enter phone No" id="job_at_phone_no" name="job_at_phone_no" class="form-control ajx-control">
						...
						<div class="row customer-feedback">
						   <div class="col-lg-5 col-md-5">
							  <div class="form-group">
								 <label for="job_at_position" class="customer-label">Position</label>
								 <input type="text" id="job_at_position" name="job_at_position" class="form-control ajx-control">
							   </div>
						   </div>

                        	...
                        	<table class="table table-striped">
                                <tbody>
                                    ...
                                    <tr class="cmb-last">
                                        ...
                                        <td class="cmb">
                                        	<img src="{$TEMPLATE_IMAGES}/no_image.jpg" />
                                            <button type="button" class="btn btn-blue" onmouseup="showLoading();" onclick="buy_insurance();" >Buy</button>
                                         ...
                                         <td class="cmb">
                                            ...
                                            <button type="button" style="margin-top:10px;" onmouseup="showLoading();" onclick="buy_insurance();" class="btn btn-blue">Buy</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
